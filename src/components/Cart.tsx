...
function generateOrderNumber() {
  return `#SV${Math.floor(100000 + Math.random() * 900000)}`;
}
    ...
    <>
            ...
            <>
              ...
              <div className="border-t border-border bg-secondary/30 px-5 py-4">
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-xl bg-primary py-3 font-semibold tracking-wide text-primary-foreground transition-all duration-200 hover:bg-primary/90 hover:glow-strong focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:outline-none active:scale-[0.99]"
                >
                  Place Order
                </button>
              </div>
      ...
      <Dialog open={successOpen} onOpenChange={setSuccessOpen}>
        <DialogContent className="max-w-sm rounded-2xl p-6 text-center">
          ...
          <h2 className="mt-4 text-xl font-bold">Order Placed Successfully!</h2>
          <p className="mt-1 text-sm text-muted-foreground">Your order has been added successfully.</p>
          ...
          <button
            ...
            className="mt-5 w-full rounded-xl bg-primary py-3 font-semibold text-primary-foreground transition-all duration-200 hover:bg-primary/90 focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:outline-none active:scale-[0.99]"
          >
            Continue Shopping
          </button>
        </DialogContent>
